            ...
            >
                <form onSubmit={handleSubmit}>
                    <div className="flex justify-between items-center mb-6">
                        <h3 className="text-2xl font-bold">Form Peminjaman</h3>
                        <X
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-start border border-gray-600 rounded-lg p-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Contoh: Perjalanan dinas ke..."
                                />
                            </div>
                        </div>
                    </div>
