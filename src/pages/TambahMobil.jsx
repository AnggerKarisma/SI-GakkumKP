...
// Dikelompokkan berdasarkan kolom untuk rendering yang dinamis
const dataMobilFields = [
  // Kolom kiri
  [
    { id: "nama_mobil", label: "Nama Mobil" },
    { id: "plat", label: "Plat" },
...
const TambahMobil = ({ isSidebarOpen }) => {
  // State tunggal untuk mengelola semua data formulir
    ...
    <div className="transition-all flex duration-300">
      ...
      >
        <div className="flex flex-col px-3 py-2 h-full">
          ...
          <form className="flex flex-col gap-3 h-fit p-5 mt-3 bg-[#171717] rounded-lg md:rounded-2xl" onSubmit={handleSubmit}>
            <div className="flex justify-between">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  customWidth={"w-30"}
                  onClick={handleReset}
                  type={"button"} // Ubah ke "button" agar tidak men-submit form
                />
                <Button
                  text={"Simpan"}
                  bgColor={"bg-[#1f4f27]"}
            ...
            {/* Bagian formulir sekarang dirender secara dinamis */}
            <div className="flex flex-col gap-5 h-full">
              <FormKendaraan title="Data Mobil" fields={dataMobilFields} formData={formData} handleChange={handleChange} />
              <FormKendaraan title="Data STNK" fields={dataStnkFields} formData={formData} handleChange={handleChange} />
            </div>
          </form>
        </div>
      </div>
