...
const dataKendaraanFields = [
  { id: "nama_kendaraan", label: "Nama Kendaraan" },
  { id: "plat", label: "Plat" },
      ...
      >
        <div className="flex flex-col h-full">
          <header className="mb-4">
            <p className="text-white font-semibold text-2xl">Manajemen Pajak</p>
          </header>
          <form
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <p className="text-white font-semibold text-xl">Proses Pajak</p>
